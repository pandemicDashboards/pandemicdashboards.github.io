const page = (function () {
    ...
    function initHeader() {
        ...
        titleDiv.append($(`<a href="https://github.com/pandemicDashboards/pandemicdashboards.github.io"><img title="SurVis ${window.surVisVersion}" src="${stylesDir}img/survis_small.png"/></a>`));
    ...
    function openExtraPage(pageName, pageSrc) {
        ...
        if (pageName == 'Entry') {
            extraPage.attr('title', 'Add ' + pageName);
        }
        else {
