const warnings = (function () {
    ...
    return {
        ...
        expectedFields: {
            inproceedings: ['data_type', 'booktitle', 'pages', 'publisher', 'title', 'year', 'doi'],
            article: ['data_type', 'journal', 'number', 'pages', 'title', 'volume', 'year', 'doi'],
            techreport: ['data_type', 'institution', 'title', 'year'],
            incollection: ['data_type', 'booktitle', 'pages', 'publisher', 'title', 'year'],
            book: ['data_type', 'publisher', 'title', 'year'],
            inbook: ['data_type', 'booktitle', 'pages', 'publisher', 'title', 'year'],
            proceedings: ['editor', 'publisher', 'title', 'year'],
            phdthesis: ['data_type', 'school', 'title', 'year'],
            mastersthesis: ['data_type', 'school', 'title', 'year'],
            bachelorsthesis: ['data_type', 'school', 'title', 'year'],
            electronic: ['data_type', 'title', 'url', 'year'],
            misc: ['data_type', 'howpublished', 'title', 'year']
        },
    ...
    function computeFirstNameUnknown(warningsList, field, value) {
        if (field === 'data_type' || field === 'editor') {
